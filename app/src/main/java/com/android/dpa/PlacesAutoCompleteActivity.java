                        ...
                        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
                            ...
                            public void onResult(PlaceBuffer places) {
                                if(places.getCount()==1){
                                    ...
                                    intent.putExtra("Lat",String.valueOf(places.get(0).getLatLng().latitude));
                                    intent.putExtra("Lng",String.valueOf(places.get(0).getLatLng().longitude));
                                    intent.putExtra("Location Data",String.valueOf(item.description));
                                    intent.putExtra("Place Id",String.valueOf(item.placeId));
